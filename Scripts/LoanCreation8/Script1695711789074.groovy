...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Online Personal Loans  Full-Service Ba_ac9e03/select_Whats the money forCredit card refin_9ce23e'), 
    5, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_Online Personal Loans  Full-Service Ba_ac9e03/select_Whats the money forCredit card refin_9ce23e'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('loan_creation8')
